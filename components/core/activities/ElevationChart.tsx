...
export default function ElevationChart({ activity }: { activity: Activity }) {
    ...
    const chartData = activity.elevation.elevationPoints.map((elevation, index) => ({
        value: [activity.distance * (index / activity.elevation.elevationPoints.length), elevation],
